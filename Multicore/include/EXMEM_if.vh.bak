...
modport EXMEM
(
	input branch_hit_ex, branch_history_ex, target_address_ex, lduse_hit_ex, imemaddr_ex, imemload_ex, branch_target_ex, imm16_ex, enable_exmem, dhit, flush_exmem, zero_ex, beq_ex, bne_ex, jr_ex, jal_ex, jump_ex, mem2reg_ex, halt_ex, lui_ex, dREN_ex, dWEN_ex, RegWr_ex, RegDst_ex, rdat1_ex, rdat2_ex, pc_nextstate_ex, wdat_ex, jumpaddr_ex, jumpoffset_ex,
	output branch_hit_mem, branch_history_mem, target_address_mem, lduse_hit_mem, imemaddr_mem, imemload_mem, branch_target_mem, imm16_mem, jal_mem, mem2reg_mem, halt_mem, lui_mem, dmemren, dmemwen, zero_mem, beq_mem, bne_mem, RegWr_mem, RegDst_mem, pc_nextstate_mem, dmemaddr, dmemstore, wdat_mem, dmemload_mem
);
